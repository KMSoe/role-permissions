...
<head>
    ...
    <title>Login - OMG Game Shop  </title>
...
<body class="antialiased bg-slate-200">
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <div class="my-3 flex space-x-1">
            <a href="{{ route('auth.login.google') }}" class="w-full text-center py-3 my-3 border flex space-x-2 items-center justify-center border-slate-200 rounded-lg text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
                <img src="https://www.svgrepo.com/show/355037/google.svg" class="w-6 h-6" alt="Google Icon"> <span>Login with Google</span>
            </a>
            <a href="{{ route('auth.login.facebook') }}" class="w-full text-center py-3 my-3 border flex space-x-2 items-center justify-center border-slate-200 rounded-lg text-slate-700 hover:border-slate-400 bg-blue-500 hover:bg-blue-800 hover:text-slate-900 hover:shadow transition duration-150">
        ...
        <form action="{{ route('auth.login.store') }}" method="POST" class="my-3">
            @csrf
            <div class="flex flex-col space-y-5">
                ...
                <div class="flex flex-row justify-between">
                    <div>
                        <label for="remember" class="">
                            <input type="checkbox" id="remember" name="remember" class="w-4 h-4 border-slate-200 focus:bg-indigo-600">
                            Remember me
                        </label>
                    </div>
                    <div>
                ...
                <p class="text-center">Not registered yet? <a href="{{ route('auth.register') }}" class="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
