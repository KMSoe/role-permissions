<template>
    <div>
      ...
      <h1 class="mb-8 text-3xl font-bold">
        ...
        <span class="text-indigo-400 font-medium">/</span> {{ banner.title }}
      </h1>
      <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
        <form @submit.prevent="submit">
          <div class="flex flex-wrap -mb-8 -mr-6 p-8">
            ...
            <div>
              <input type="checkbox" id="show_banner" class="mr-3" v-model="status" />
  ...
  export default {
    ...
    methods: {
      submit() {
        this.form.put(this.route('admin.banners.update', {id: this.banner.id}))
      },
    },
  }
  </script>
